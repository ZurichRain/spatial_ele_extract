...
def f1_score(y_true, y_pred,labels,label2id,mode='dev'):
    ...
    Example:
        ...
        0.50
    """
    id2ele={v:k for k,v in label2id.items()}
    # print(y_true)
    if(isinstance(y_true[0],list)):
        y_true=[[id2ele[idx] for idx in lis ] for lis in y_true]
        y_pred=[[id2ele[idx] for idx in lis ] for lis in y_pred]
    else:
